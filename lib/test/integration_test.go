...
func TestIntegration(t *testing.T) {
	...
	envelope := meta.Envelope{
		...
		Value:     map[string]interface{}{"metrics": map[string]interface{}{"level": 42, "level_unit": "test2", "thisisatestforveryveryveryveryveryverylongfieldnameswhichneedtobehashed": 42, "title": "event", "updateTime": 13, "listvariable": []map[string]interface{}{{"value": 12, "value2": 34}, {"value": 56, "value2": 78}, {"value": 90, "value2": 12}}, "listfixed": []map[string]interface{}{{"value": 12, "value2": 34}, {"value": 56, "value2": 78}}, "listfixedsimple": []interface{}{12, 34}}, "other_var": "foo"},
	}
	...
	if !strings.Contains(string(item.Value), `"value":{"metrics":{"level":42,"level_unit":"test2","listfixed":[{"value":12,"value2":34},{"value":56,"value2":78}],"listfixedsimple":[12,34],"listvariable":[{"value":12,"value2":34},{"value":56,"value2":78},{"value":90,"value2":12}],"thisisatestforveryveryveryveryveryverylongfieldnameswhichneedtobehashed":42,"title":"event","updateTime":13},"other_var":"foo"}}`) {
	...
	lastValueResp, err := lastValueQuery(timescaleWrapperUrl, []map[string]interface{}{
		...
		{
			"columnName": "metrics.thisisatestforveryveryveryveryveryverylongfieldnameswhichneedtobehashed",
			"deviceId":   d.Id,
			"serviceId":  dt.Services[0].Id,
		},
		{
			"columnName": "metrics.listfixedsimple.0",
			"deviceId":   d.Id,
			"serviceId":  dt.Services[0].Id,
		},
		{
			"columnName": "metrics.listfixedsimple.1",
			"deviceId":   d.Id,
			"serviceId":  dt.Services[0].Id,
		},
	})
	...
	normalizedRequest := normalizeLastValueResp([]map[string]interface{}{{"value": 42.0}, {"value": "foo"}, {"value": []interface{}{map[string]interface{}{"value": 12.0, "value2": 34.0}, map[string]interface{}{"value": 56.0, "value2": 78.0}, map[string]interface{}{"value": 90.0, "value2": 12.0}}}, {"value": 56.0}, {"value": 42.0}, {"value": 12.0}, {"value": 34.0}})
